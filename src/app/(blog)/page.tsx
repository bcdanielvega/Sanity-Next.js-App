...
export default async function Page() {
  ...
  <div className="container mx-auto mt-10 prose prose-xl p-f flex items-center justify-center arimo bg-mintcream flex-col mb-0">
    ...
    <div className="text-justify">MILESTONES is a collection of albums, artists, and genres that I want to share with my son <span className="font-bold">Miles</span>. Music is a lifelong passion of mine, and these are albums that have shaped my life in some form or fashion.</div>
  </div>
  <div className={`container mx-auto prose prose-lg p-4 flex items-center justify-center arimo bg-mintcream`}>
    <h2 className="text-center uppercase">
      These are Daniel's Favorite Albums - but there are so many <Link href="/albumReviews">more!</Link>
    </h2>
  </div>
